...
// Lớp chính của chương trình, chứa hàm main
public class CoSoYTe {
    ...
    public static void themDuLieuMau() {
        ...
        // Mẫu Dịch Vụ
        qlDichVu.themDV(new Thuoc("T001", "Paracetamol", 15000, "Vien"));
        qlDichVu.themDV(new Thuoc("T002", "Berberin", 20000, "Vien"));
        qlDichVu.themDV(new XetNghiem("XN001", "Xet nghiem mau", 150000, "May ly tam", "Mau"));
        qlDichVu.themDV(new XetNghiem("XN002", "Sieu am o bung", 200000, "May sieu am", "Hinh anh"));
