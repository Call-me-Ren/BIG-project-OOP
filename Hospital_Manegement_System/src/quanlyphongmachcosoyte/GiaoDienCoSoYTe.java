...
public class GiaoDienCoSoYTe extends JFrame {
    ...
    private QL_BenhNhan quanLyBenhNhan = new QL_BenhNhan(); 
    private QL_NhanVien quanLyNhanVien = new QL_NhanVien(); 
    private QL_DichVu quanLyDichVu = new QL_DichVu(); 
    private QL_GiaoDich quanLyGiaoDich = new QL_GiaoDich(); 
    ...
    private JPanel taoBangQuanLyBenhNhan() {
        ...
        bangNhapLieu.add(new JLabel("Ma ID (CCCD):")); bangNhapLieu.add(oNhapMaID);
        bangNhapLieu.add(new JLabel("Ho Ten:")); bangNhapLieu.add(oNhapHoTen);
        bangNhapLieu.add(new JLabel("Ngay Sinh:")); bangNhapLieu.add(oNhapNgaySinh);
        bangNhapLieu.add(new JLabel("Gioi Tinh:")); bangNhapLieu.add(oNhapGioiTinh);
        bangNhapLieu.add(new JLabel("SDT:")); bangNhapLieu.add(oNhapSDT);
        bangNhapLieu.add(new JLabel("Ma BN:")); bangNhapLieu.add(oNhapMaBN);
        bangNhapLieu.add(new JLabel("Ngay Vao:")); bangNhapLieu.add(oNhapNgayVao);
        bangNhapLieu.add(new JLabel("Benh Ly:")); bangNhapLieu.add(oNhapBenhLy);
        ...
        nutTimBN.addActionListener(e -> {
            ...
            for (BenhNhan bn : quanLyBenhNhan.layDanhSachBN()) {
                if (bn.layMaBN().toLowerCase().contains(tuKhoa)) ketQua.add(bn);
            }
        ...
        nutThem.addActionListener(e -> {
            try {
                if(oNhapMaBN.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Chua nhap Ma BN!"); return;
                }
            ...
            } catch (Exception ex) { JOptionPane.showMessageDialog(this, "Loi: " + ex.getMessage()); }
        });
        ...
        nutXoa.addActionListener(e -> {
            ...
            } else JOptionPane.showMessageDialog(this, "Chon dong can xoa!");
        });
        
        nutLamMoi.addActionListener(e -> {
            oNhapTimKiemBN.setText("");
            oNhapMaID.setText(""); oNhapHoTen.setText(""); oNhapMaBN.setText(""); oNhapBenhLy.setText("");
            napDuLieuBenhNhanLenBang(quanLyBenhNhan.layDanhSachBN());
        });
    ...
    private JPanel taoBangQuanLyNhanVien() {
        ...
        bangNhapLieu.add(new JLabel("Loai Nhan Vien:")); bangNhapLieu.add(hopChonLoaiNV);
        bangNhapLieu.add(new JLabel("Ma NV:")); bangNhapLieu.add(oNhapNV_MaNV);
        bangNhapLieu.add(new JLabel("Ho Ten:")); bangNhapLieu.add(oNhapNV_HoTen);
        bangNhapLieu.add(new JLabel("Chuc Vu:")); bangNhapLieu.add(oNhapNV_ChucVu);
        bangNhapLieu.add(new JLabel("He So Luong:")); bangNhapLieu.add(oNhapNV_HeSoLuong);
        bangNhapLieu.add(new JLabel("Ma ID (CCCD):")); bangNhapLieu.add(oNhapNV_MaID);
        bangNhapLieu.add(new JLabel("Ngay Sinh:")); bangNhapLieu.add(oNhapNV_NgaySinh);
        bangNhapLieu.add(new JLabel("Gioi Tinh:")); bangNhapLieu.add(oNhapNV_GioiTinh);
        bangNhapLieu.add(new JLabel("So Dien Thoai:")); bangNhapLieu.add(oNhapNV_SDT);
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (dong >= 0) {
                    ...
                    if (nv != null) {
                        ...
                        oNhapNV_HoTen.setText(nv.hoTen);
                        oNhapNV_ChucVu.setText(nv.chucVu);
                        oNhapNV_HeSoLuong.setText(String.valueOf(nv.heSoLuong));
                        oNhapNV_MaID.setText(nv.maID);
                        oNhapNV_NgaySinh.setText(nv.ngaySinh);
                        oNhapNV_GioiTinh.setText(nv.gioiTinh);
                        oNhapNV_SDT.setText(nv.soDienThoai);
                        
                        if (nv instanceof BacSi) hopChonLoaiNV.setSelectedItem("Bac Si");
                        else if (nv instanceof DieuDuong) hopChonLoaiNV.setSelectedItem("Dieu Duong");
                        else hopChonLoaiNV.setSelectedItem("Ky Thuat Vien");
                    }
                }
            }
        });
        ...
        nutTimNV.addActionListener(e -> {
            ...
            for (NhanVien nv : quanLyNhanVien.layDanhSachNV()) {
                if (nv.layMaNV().toLowerCase().contains(tuKhoa)) ketQua.add(nv);
            }
        ...
        nutThemNV.addActionListener(e -> {
            try {
                if (oNhapNV_MaNV.getText().isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Chua nhap Ma NV!"); return;
                }
        ...
        nutSuaNV.addActionListener(e -> {
            ...
            if (nv != null) {
                try {
                    nv.hoTen = oNhapNV_HoTen.getText();
                    nv.chucVu = oNhapNV_ChucVu.getText();
                    nv.heSoLuong = Double.parseDouble(oNhapNV_HeSoLuong.getText());
                    nv.soDienThoai = oNhapNV_SDT.getText();
        ...
        nutLamMoiNV.addActionListener(e -> {
            ...
            oNhapNV_MaNV.setText(""); oNhapNV_HoTen.setText(""); oNhapNV_ChucVu.setText(""); oNhapNV_HeSoLuong.setText("");
            napDuLieuNhanVienLenBang(quanLyNhanVien.layDanhSachNV());
        });
    ...
    private void napDuLieuNhanVienLenBang(List<NhanVien> danhSachDuLieu) {
        ...
        for (NhanVien nv : danhSachDuLieu) {
            ...
            if (nv instanceof BacSi) loai = "Bac Si";
            else if (nv instanceof DieuDuong) loai = "Dieu Duong";
            else if (nv instanceof KiThuatVien) loai = "Ky Thuat Vien";

            moHinhBangNhanVien.addRow(new Object[]{
                loai, nv.layMaNV(), nv.hoTen, nv.chucVu, nv.heSoLuong, String.format("%.0f", nv.tinhLuong())
            });
        }
    }
                ...
                if (dong >= 0) {
                    ...
                    if (hd != null) {
                        ...
                        for (DichVuYTe dv : hd.layDanhSachDichVuSuDung()) {
                            sb.append("- ").append(dv.tenDV).append(": ").append(String.format("%,.0f", dv.tinhChiPhi())).append(" VND\n");
                        }
                        sb.append("----------------\n");
    ...
    private JPanel taoBangLapHoaDon() {
        ...
        bangThongTin.add(new JLabel("Ma Hoa Don:")); bangThongTin.add(oNhapHDMaHD);
        bangThongTin.add(new JLabel("Ma BN:")); bangThongTin.add(oNhapHDBN);
        bangThongTin.add(new JLabel("Ngay Lap (DD/MM/YYYY):")); bangThongTin.add(oNhapHDNgayLap);
        bangThongTin.add(nhanTongTien); bangThongTin.add(nutLapHD);
        ...
        nutThemDV.addActionListener(e -> {
            ...
            if (dong >= 0) {
                ...
                if (dv != null) {
                    ...
                    moHinhBangChiTietHD.addRow(new Object[]{maDV, dv.tenDV, String.format("%,.0f", chiPhi)});
                    capNhatTongTien.run();
                }
            } else JOptionPane.showMessageDialog(this, "Chon dich vu can them!");
        });
        ...
        nutXoaDVChiTiet.addActionListener(e -> {
            ...
            if (dong >= 0) {
                ...
                capNhatTongTien.run();
            } else JOptionPane.showMessageDialog(this, "Chon dich vu trong danh sach chi tiet can xoa!");
        });
        ...
        nutLapHD.addActionListener(e -> {
            try {
                ...
                if (maHD.isEmpty() || maBN.isEmpty() || ngayLap.isEmpty()) {
                    JOptionPane.showMessageDialog(this, "Vui long nhap day du Ma HD, Ma BN va Ngay Lap!"); return;
                }
                if (quanLyGiaoDich.timKiemHD(maHD) != null) {
                    JOptionPane.showMessageDialog(this, "Loi: Ma Hoa Don da ton tai!"); return;
                }
                if (quanLyBenhNhan.timKiemBN(maBN) == null) {
                    JOptionPane.showMessageDialog(this, "Loi: Ma BN khong ton tai!"); return;
                }
                if (moHinhBangChiTietHD.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(this, "Loi: Hoa don chua co dich vu nao!"); return;
                }
                ...
                JOptionPane.showMessageDialog(this, "Lap Hoa Don thanh cong! Tong tien: " + String.format("%,.0f", hdMoi.tinhTongTien()) + " VND");
    ...
    private void napDuLieuDichVuLenBang(List<DichVuYTe> danhSachDuLieu) {
        ...
        for (DichVuYTe dv : danhSachDuLieu) {
            ...
            moHinhBangDichVu.addRow(new Object[]{
                dv.maDV, dv.tenDV, String.format("%,.0f", dv.giaTien), loaiDV
            });
        }
    }
