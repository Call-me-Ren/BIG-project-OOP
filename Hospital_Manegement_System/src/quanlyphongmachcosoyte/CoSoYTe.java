...
public class CoSoYTe {
    ...
    public static void main(String[] args) {
        System.out.println("Console application retired. Starting GUI from GiaoDienYTe.java...");
    }
    ...
    public static void docTatCaDuLieu() {
        ...
        if (quanLyBenhNhan.kiemTraRong() && quanLyDichVu.kiemTraRong() && quanLyNhanVien.kiemTraRong() && quanLyGiaoDich.layDanhSachHoaDon().isEmpty()) {
    ...
    public static void themDuLieuMau() {
        ...
        quanLyNhanVien.themNV(new BacSi("CCCD100", "Nguyen Van Bac Si", "01/01/1980", "Nam", "011111111", "BS001", "Truong Khoa", 5.0, 5000000));
        quanLyNhanVien.themNV(new DieuDuong("CCCD101", "Tran Thi Dieu Duong", "02/02/1990", "Nu", "022222222", "DD001", "Dieu duong truong", 3.5, 2000000, 10));
        quanLyNhanVien.themNV(new KiThuatVien("CCCD102", "Le Van KTV", "03/03/1995", "Nam", "033333333", "KTV001", "KTV Xet nghiem", 3.0, 1000000, 500000, 20));
